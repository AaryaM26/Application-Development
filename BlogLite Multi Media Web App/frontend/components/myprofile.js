const Myprofile = {
  ...
  <p style="text-align:left ;font-size: 25px">
      <b style="font-family:Trebuchet MS; font-size:25px;color:#e4ebef">Profile</b>
     ...
     <div class="py-5">
          <div class="container text-center">
              ...
              <div v-if = "post.imageLink.length > 0"><img  v-bind:src="post.imageLink" class="card-img-top"  alt="post.title"/></div>
<br>
                <div class="card-body">
